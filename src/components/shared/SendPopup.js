...
const SendPopup = (props) => {
        ...
        function closeModal() {
            props.setsendModal(false);
        }

  return (
    <>
    <Transition appear show={props.sendModal} as={Fragment}>
        <Dialog as='div' className='relative z-[999999]' onClose={closeModal}>
          ...
          <div className='fixed inset-0 overflow-y-auto'>
              ...
              >
                <Dialog.Panel className='relative bg-white w-full max-w-[500px] transform overflow-hidden rounded-2xl bg-sooth p-5 text-left align-middle shadow-xl transition-all'>
                 ...
                 <div className='mb-6'>
                  ...
                  <div className='text-[16px] sm7:text-[19px] text-not-black font-bold'>Send</div>
           ...
           <button className='flex w-fit mx-auto  px-7 sm:px-10 mt-10 py-3 sm:py-4 rounded-xl bg-main-color text-white'>Continue</button>
