...
<div>
  <img src="/images/paypal.svg" className="w-[100px] mx-auto mb-5" alt="paypal" />
  <div className="text-[#11047A] text-opacity-60 text-center">Pay through Paypal with easy payment method.</div>
  <button onClick={()=> {props.setshowTransaction(true)}} className="flex items-center justify-center w-full py-2.5 rounded-lg bg-[#FFB800] mt-5"><img src="/images/paypal2.svg" alt="paypal logo" /></button>
</div>
</div>
</div>
: 
