...
const CashApp = (props) => {
  ...
  return (
    <>
      ...
      <img src="/images/cashApp.svg" className="w-[160px] mx-auto mb-5" alt="Cash App" />
      <div className="text-[#11047A] text-center"><span className="text-[#11047A] text-opacity-60">Please enter your</span> <span className="font-[600]">{props.show === "DepositFunds" ? "deposit from" : "withdrawal from"}</span> <span className="text-[#11047A] text-opacity-60">&</span> <span className="font-[600]">{props.show === "DepositFunds" ? "deposit to" : "withdrawal to"}</span> <span className="text-[#11047A] text-opacity-60">Emails to place an order</span></div>
   
      <div className="mt-10">
      <div>
      <div className="font-bold text-[15px] text-[#11047A] mb-2"><span className="text-[#11047A] text-opacity-70">Email Address</span> {props.show === "DepositFunds" ? "Deposit from." : "Withdrawal from."}</div>
      ...
      <div className="font-bold text-[15px] text-[#11047A] mb-2"><span className="text-[#11047A] text-opacity-70">Email Address</span> {props.show === "DepositFunds" ? "Deposit to." : "Withdrawal to."}</div>
      ...
      <button onClick={validation} className="w-full bg-main-color px-3 py-3 text-white rounded-lg mt-6">{props.show === "DepositFunds" ? "Place Order" : "Withdrawal"}</button>
